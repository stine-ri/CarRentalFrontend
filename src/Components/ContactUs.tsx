  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.newsletterContainer}>
        ...
        <p>
          Add your details and you'll receive our quarterly email, including what's happening with the
          wild of new cars, affordable cars, and comfortable cars around stine Rental.
        </p>
